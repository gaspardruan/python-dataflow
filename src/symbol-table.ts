...
import { ATTRIBUTE, IDENTIFIER } from './type';
...
export class SymbolTable {
  ...
  // TODO: handle multiple submodules: a.b.c()
  public lookupNode(func: SyntaxNode) {
    return func.type === IDENTIFIER
      ? this.lookupFunction(func.text)
      : func.type === ATTRIBUTE && func.childForFieldName('object')!.type === IDENTIFIER
        ? this.lookupModuleFunction(func.childForFieldName('object')!.text, func.text)
        : undefined;
  }
  ...
  public importModule(modulePath: string, alias: string): ModuleSpec<FunctionSpec> | undefined {
  ...
  ): ModuleSpec<FunctionSpec> | undefined {
  ...
  private lookupSpec(map: JsonSpecs, parts: string[]): ModuleSpec<FunctionSpec> | undefined {
